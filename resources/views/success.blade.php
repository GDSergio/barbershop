    ...
    <div class="container">
        <div class="card border-0 shadow my-5">
            <div class="card-body p-5">
                <h1 class="font-weight-light">¡Gracias por realizar una reserva con nosotros!</h1>
                <p class="lead">Estaremos esperando tu llegada.</p>
                ...
                <p class="lead">Puedes encontrarnos aca:</p>
                <p class="lead">
